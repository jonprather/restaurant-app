...
export default function Nav() {
  ...
  const navList = [
    { name: "menu", link: "/menu/all" },
    { name: "our specials", link: "/#popular-products" },
    { name: "about us", link: "/#about" },
    { name: "our locations", link: "#footer" },
  ...
  return (
    <nav role='navigation' className='nav z-50 relative pb-20 my-auto'>
      ...
      <div className='nav-menu '>
        {navList.map((navItem) => {
          return (
            <span key={navItem.link} className='my-auto'>
